...
Load tabular training data from common file formats and compute a statistical
profile (`DataProfile`) that is stored alongside the canonical artifact. The
capability is entirely DuckDB-based — no pandas dependency — and operates
