...
Compute model explanations (SHAP values, decision paths, partial dependence
profiles) at extraction time and store them frozen in the canonical artifact.
No live model is needed at view time. The explanations module MUST NOT import
LightGBM at module level.
